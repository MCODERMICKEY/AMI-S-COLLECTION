...
const PRODUCTS = [
  ...
  { id: "p22", name: "V-Neck Halter Waist-Cinching Wide-Leg Jumpsuit", category: "Jumpsuits", occasion: "Party", price: 120, condition: "New", image: "Photos/P22.jpg", colors: [{ name: "Champagne", hex: "#d4b872" }, { name: "Red", hex: "#c0392b" }, { name: "Grey", hex: "#c4c4c4" }, { name: "Green", hex: "#8ec06a" }, { name: "Purple", hex: "#7d5ba6" }, { name: "Beige", hex: "#e3d3b8" }], description: "A high-end satin jumpsuit with a plunging V-neck halter and a waist-cinching seam for a sleek silhouette. Flowing wide-leg trousers add drama and movement. A luxe, streetwear-inspired piece for parties, summer events, or a standout night out.", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: "p23", name: "Satin Zipper Sleeveless Slim Mermaid Dress", category: "Dresses", occasion: "Party", price: 120, condition: "New", image: "Photos/P23.jpg", colors: [{ name: "Nude", hex: "#d9b78f" }, { name: "Blue", hex: "#1f3fa0" }, { name: "Black", hex: "#1c1c1c" }, { name: "Purple", hex: "#5b3a8a" }, { name: "Royal Blue", hex: "#2547b8" }], description: "A high-shine satin gown with a sleeveless, zip-back design and a fitted mermaid silhouette that flares dramatically at the hem. The glossy fabric and clean lines create a dramatic, red-carpet-ready look. A striking choice for galas, weddings, or any high-glam evening event.", sizes: ["S", "M", "L", "XL", "XXL"] },
