...
const PRODUCTS = [
  ...
  { id: "p20", name: "Leopard Print Lace Patchwork Bra & Panty Set", category: "Lingerie", occasion: "Intimate", price: 130, condition: "New", image: "Photos/P20.jpg", colors: [{ name: "Leopard", hex: "#8a6a3c" }], description: "A bold leopard-print bra and panty set with black lace trim along the neckline and a lace-up front detail. Adjustable straps and gold-tone hardware on the panty sides for a sultry, statement look. A breathable, comfortable set with plenty of attitude.", sizes: ["S", "M", "L", "XL"] },
  { id: "p21", name: "Halter Neck Pleated Wide-Leg Jumpsuit", category: "Jumpsuits", occasion: "Corporate", price: 350, condition: "New", image: "Photos/P21.jpg", colors: [{ name: "Apricot", hex: "#e6cba8" }, { name: "Pink", hex: "#e8b8b0" }], description: "An elegant sleeveless jumpsuit with a halter neckline, a cinched, pleated waist, and flowing wide-leg trousers. A subtle cut-out detail at the waist adds a modern touch. Made from a smooth, structured fabric — perfect for semi-formal events, dinner dates, or an elevated day-to-night look.", sizes: ["S", "M", "L", "XL"] },
  { id: "p22", name: "V-Neck Halter Waist-Cinching Wide-Leg Jumpsuit", category: "Jumpsuits", occasion: "Party", price:350, condition: "New", image: "Photos/P22.jpg", colors: [{ name: "Champagne", hex: "#d4b872" }, { name: "Red", hex: "#c0392b" }, { name: "Grey", hex: "#c4c4c4" }, { name: "Green", hex: "#8ec06a" }, { name: "Purple", hex: "#7d5ba6" }, { name: "Beige", hex: "#e3d3b8" }], description: "A high-end satin jumpsuit with a plunging V-neck halter and a waist-cinching seam for a sleek silhouette. Flowing wide-leg trousers add drama and movement. A luxe, streetwear-inspired piece for parties, summer events, or a standout night out.", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: "p23", name: "Satin Zipper Sleeveless Slim Mermaid Dress", category: "Dresses", occasion: "Party", price: 300, condition: "New", image: "Photos/P23.jpg", colors: [{ name: "Nude", hex: "#d9b78f" }, { name: "Blue", hex: "#1f3fa0" }, { name: "Black", hex: "#1c1c1c" }, { name: "Purple", hex: "#5b3a8a" }, { name: "Royal Blue", hex: "#2547b8" }], description: "A high-shine satin gown with a sleeveless, zip-back design and a fitted mermaid silhouette that flares dramatically at the hem. The glossy fabric and clean lines create a dramatic, red-carpet-ready look. A striking choice for galas, weddings, or any high-glam evening event.", sizes: ["S", "M", "L", "XL", "XXL"] },
  { id: "p24", name: "Deep V-Neck Lace Sleeve Ruffle Bodycon Mini Dress", category: "Dresses", occasion: "Party", price: 250, condition: "New", image: "Photos/P24.jpg", colors: [{ name: "Red", hex: "#b3122a" }], description: "A sultry bodycon mini dress in bold red, featuring a plunging deep V-neckline and sheer lace long sleeves. Ruched detailing through the waist creates a flattering, fitted shape, finished with a flirty asymmetric ruffle hem. A show-stopping pick for parties, date nights, or an elegant evening out.", sizes: ["S", "M", "L", "XL"] },
  { id: "p25", name: "Deep V-Neck Halter Backless Double Ruffle Mini Dress", category: "Dresses", occasion: "Party", price: 350, condition: "New", image: "Photos/P25.jpg", colors: [{ name: "Red", hex: "#a8172c" }], description: "A sultry satin mini dress in rich red, featuring a plunging halter neckline and a backless design. Ruched detailing cinches the waist for a flattering shape, finishing in a flirty double ruffle hem. A glamorous pick for parties, holidays, or a bold night out.", sizes: ["S", "M", "L", "XL"] },
  { id: "p26", name: "Camisole Ruched High-Thigh Slit Bodycon Dress", category: "Dresses", occasion: "Party", price: 250, condition: "New", image: "Photos/P26.jpg", colors: [{ name: "Lotus Pink", hex: "#d98fa0" }, { name: "Rust", hex: "#b5583a" }, { name: "Mustard", hex: "#d4a92e" }, { name: "Brown", hex: "#5a3a28" }, { name: "Blue", hex: "#3355c9" }, { name: "Black", hex: "#1c1c1c" }], description: "A sleek satin camisole dress with ruched draping through the bodice and a high-thigh side slit. Fitted through the body for a flattering bodycon silhouette that skims to a floor-length hem. An elegant choice for parties, dinners, graduations, or any dressed-up occasion.", sizes: ["S", "M", "L", "XL"] },
  { id: "p27", name: "Ruffle Shoulder Pleated Fit-and-Flare Midi Dress", category: "Dresses", occasion: "Party", price: 250, condition: "New", image: "Photos/P27.jpg", colors: [{ name: "Pink", hex: "#d99aa8" }], description: "A sweet pleated midi dress in dusty pink, featuring statement ruffle shoulder straps and a fitted bodice. The full accordion-pleated skirt falls to a flattering midi length with beautiful movement. An elegant choice for holiday parties, celebrations, or a dressed-up day out.", sizes: ["S", "M", "L", "XL"] },
  { id: "p28", name: "Leopard Trim Lace Plus-Size Backless Bra", category: "Lingerie", occasion: "Intimate", price: 120, condition: "New", image: "Photos/P28.jpg", colors: [{ name: "White Leopard Trim", hex: "#efe9e2" }], description: "A supportive plus-size bra in white lace with leopard-print trim along the straps and band. Antidroop, anti-slip, and anti-outward-spread design gives full coverage and gentle shaping, with a comfortable backless-style band for all-day wear. A pretty, practical everyday piece.", sizes: ["S", "M", "L", "XL"] },
  { id: "p29", name: "Mesh-Panel Lace Underwire Plus-Size Bra", category: "Lingerie", occasion: "Intimate", price: 120, condition: "New", image: "Photos/P29.jpg", colors: [{ name: "White", hex: "#f2eee6" }], description: "A supportive plus-size underwire bra in white lace with sheer mesh paneling and strappy cut-out detailing at the center. Adjustable straps and a wide back band give secure, comfortable support. A pretty, feminine everyday piece designed for good support and all-day comfort.", sizes: ["S", "M", "L", "XL"] },
  { id: "p30", name: "Lace Patchwork Bow Bralette & Shorts Set", category: "Lingerie", occasion: "Intimate", price: 150, condition: "New", image: "Photos/P30.jpg", colors: [{ name: "White", hex: "#f2eee6" }], description: "A plus-size lace bralette and shorts set with a sheer floral lace overlay, crisscross straps, and delicate bow accents at the center front and waist. Scalloped edges throughout for a soft, feminine finish. A breathable, comfortable set that feels as pretty as it looks.", sizes: ["S", "M", "L", "XL"] },
];
